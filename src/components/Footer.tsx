    ...
    <footer className="border-t border-gray-200 bg-white">
      <div className="container mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="font-semibold text-lg mb-4">BankStream</h3>
            <p className="text-muted-foreground text-sm mb-4">
              The world's most trusted bank statement converter. Convert PDF statements to Excel in seconds.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#banks" className="text-muted-foreground hover:text-primary transition-colors duration-200">Supported Banks</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors duration-200">Pricing</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors duration-200">FAQs</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground mb-4 md:mb-0">
            © {new Date().getFullYear()} BankStream. All rights reserved.
          </p>
