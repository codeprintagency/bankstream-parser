          ...
          <TabsContent value="troubleshooting">
            <ScrollArea className="h-[60vh] border rounded-md p-4">
              <div className="space-y-4">
                ...
                <div className="space-y-2 border-l-2 border-blue-300 pl-3">
                  <h4 className="font-medium">2. PDF Size Issues</h4>
                ...
                <div className="space-y-2 border-l-2 border-blue-300 pl-3">
                  <h4 className="font-medium">3. Network and Firewall Issues</h4>
                ...
                <div className="space-y-2 border-l-2 border-blue-300 pl-3">
                  <h4 className="font-medium">4. Text Extraction Fallback</h4>
